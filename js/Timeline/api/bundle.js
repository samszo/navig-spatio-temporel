...
p._onMoveInstantEvent(img,domEvt,evt);
});
...
p._onOutInstantEvent(img,domEvt,evt);
...
/* afficher l'article */
document.getElementsByTagName('iframe').item(0).src=evt.getLink();
/*
...
Timeline.DurationEventPainter.prototype._onMoveInstantEvent=function(icon,domEvt,evt){
...
Timeline.DurationEventPainter.prototype._onOutInstantEvent=function(icon,domEvt,evt){
	domEvt.cancelBubble=true;
};
